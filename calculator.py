...
# Form implementation generated from reading ui file 'C:\Users\Semih\OneDrive - GALATASARAY UNIVERSITESI\Masaüstü\projeler\calculator.ui'
#
...
class Ui_MainWindow(object):
    ...
    #Decimal function REVIEW IT LIKE 86.5+54.6 SOLVE IT
    def dot_it(self):
    ...
    def math_it(self):
        ...
        self
    #Change + or - REVIEW WHEN IT IS LIKE -65-43 IT  MAKES 6543 SOLVE
    ...
    def press_it(self,pressed):
        if pressed=="c":
            ...
            #Check to see if it stars it 0 and deletes it
            if self.outputLabel.text()=="0":
                self.outputLabel.setText("")

            #Concatenate the pressed button with what was written previously
            self.outputLabel.setText(f'{self.outputLabel.text()}{pressed}')    

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "CalculatorSem"))
